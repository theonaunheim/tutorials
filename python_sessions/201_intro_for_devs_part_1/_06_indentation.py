...
## executable code. In most languages, these code blocks are deliminted through
...
## section stops.
##
## Note: the color is also used for dictionaries to separate keys and values:
...
## So to qualify our previous rule: whitespace is always significant, unless
## it's not. Delimiters like (), [], and {} may make it insignificant.
##
##=============================================================================
## Questions?
##=============================================================================
