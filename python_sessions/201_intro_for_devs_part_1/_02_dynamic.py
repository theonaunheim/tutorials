...
## benefits you, the programmer, because thetry/fail workflow process is often
## the quickest and most efficient way to find solutions.
##
...
##     c = 500;
##
## This variable 'c' points to a block of memory big enough to hold a character
## If you wanted to put something else in there like the number 500, your
## program would exhibit undefined behavior. This is what we call 'static
## typing', which is a behavior that many languages that enforce compile-time
## checks exhibit.
##
...
## no idea how to divide 5 by 'rutabaga'. It's nonsensical, so it will
## raise a TypeError, which essentially means you did something with a type
...
##=============================================================================
##
## You may have heard of object-oriented programming. In Python, you are doing
## object-programming whether you like it or not. Pretty much everything--that
## is not a keyword or an operator is an object. Again, whether it is an
## integer, or a string, or a float--is an object. We will often use the dir()
## command to inspect objects.
...
## reasons.
##
## Note: you will almost never have to delete anything, with the exception
## being the deletion of keys from dictionaries. If you want to prompt the
## garbage collector to take a large item, simply assign the None object to it.

# The "Ministry of Silly Walks" string is gone.
s = None
