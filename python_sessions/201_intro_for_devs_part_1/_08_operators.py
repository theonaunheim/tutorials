...
# '/' has also been repurposed for path creation in the 'pathlib' library.
import os
import pathlib
root = pathlib.Path('C:/')
...
## methods (note: this is not a name or designation I created. Seriously,
## that's what they are called). If we want to change how an object reacts to
## a plus sign, we would override our object's __add__() magic method like
## this:
